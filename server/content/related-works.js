  ...
  <article class="card">
    <div class="card-body">
      ...
      <div class="d-flex flex-wrap gap-1">
        <a href="#" class="badge text-bg-primary-light text-decoration-none">Green infrastructure</a>
  ...
  <article class="card">
    <div class="card-body">
      ...
      <div class="d-flex flex-wrap gap-1">
        ...
        <a href="#" class="badge text-bg-primary-light text-decoration-none">Urban climate</a>
      </div>
    </div>
  </article>
</div>`;
