module.exports = function renderBackofficeResultsRows() {
  return `
<tr>
  <td><input type="checkbox" class="form-check-input" data-bulk-row aria-label="Select Urban forests record"></td>
...
<tr>
  <td><input type="checkbox" class="form-check-input" data-bulk-row aria-label="Select tree canopy dataset"></td>
  <td><a href="#" class="fw-semibold text-decoration-none">Urban tree canopy cover measurements Belgium 2020–2025</a></td>
  <td>Dataset</td>
  <td>2026</td>
  <td><span class="badge text-bg-info">Submitted</span></td>
</tr>`;
};
