...
- `rdir-` — researcher directory (`public-researchers.html`, bar inline): Faculty/department, Current or alumni.
- `pdir-` — project directory (`public-projects.html`, bar inline): Host faculty, Status, Period (year range).
